...
describe('item detail', () => {
  it('get item detail by id should return an action', () => {
    expect(getItemDetailByIdAction(
      '5bf28847dc39e409216aea00', { data: true, validation: true }
    )).toMatchSnapshot();
  });

  it('set item detail data should return an action', () => {
    expect(setItemDetailDataAction(
      {
        rows: [
          {
            tabs: ['Tab 1', 'Tab 2'],
  ...
  it('update item detail by id should return an action', () => {
    expect(updateItemDetailByIdAction(
      '5bf28847dc39e409216aea00',
      {
        rows: [
          {
            tabs: ['Tab 1', 'Tab 2'],
  ...
  it('update item detail dimention should return an action', () => {
    expect(updateItemDetailDimensionAction(
      {
        left: 500,
        right: 400
      }
  ...
  it('move item detail widget should return an action', () => {
    expect(moveItemDetailWidgetAction({
      from: {
        widgetIndex: 2,
        rowIndex: 1,
        tabIndex: 1
